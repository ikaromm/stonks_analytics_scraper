from stonks_analytics_scraper.db.entity.stocks import Stock, StockPrice, StockStatistics
...
class StockMapper(Mapper):
    ...
    def parse_stock_statistics(self, data) -> StockStatistics:
        stock_statistics_columns = [column.key for column in StockStatistics.__table__.columns]
